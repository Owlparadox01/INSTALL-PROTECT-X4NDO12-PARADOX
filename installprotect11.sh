    ...
    <div class="col-xs-12">
                        ...
                        @foreach ($servers as $server)
                            <tr class="align-middle">
                                <td class="middle">
                                    ...
                                    @if($server->id == 26)
                                    <br><small class="text-muted">X4NDO12 PARADOX</small>
                                    @endif
                                </td>
                                ...
                                <td class="middle">
                                    ...
                                    @if($server->id == 26)
                                    <br><small><code>X4NDO12 PARADOX:2007</code></small>
                                    @endif
                                </td>
        ...
        <div class="alert alert-warning">
            ...
            <p style="margin-bottom: 0; font-size: 12px;">
                ...
                Protected by: 
                <span class="label label-primary">@XandorAcc</span>
                <span class="label label-success">@TestimoniXandor</span>
                <span class="label label-info">X4NDO12 PARADOX</span>
            </p>
        </div>
        @else
    ...
    ">
        ...
        ">
            ...
            <div style="display: flex; gap: 10px; justify-content: center; flex-wrap: wrap;">
                <span style="background: #e84393; padding: 5px 12px; border-radius: 15px; font-size: 12px;">@XandorAcc</span>
                <span style="background: #0984e3; padding: 5px 12px; border-radius: 15px; font-size: 12px;">@TestimoniXandor</span>
