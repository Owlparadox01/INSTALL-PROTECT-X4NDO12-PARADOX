    ...
    <div class="col-xs-12">
        ...
        <div class="alert alert-warning">
            ...
            <p style="margin-bottom: 0; font-size: 12px;">
                ...
                Protected by: 
                <span class="label label-primary">X4NDO12 PARADOX</span>
                <span class="label label-success">@danagvalentp</span>
                <span class="label label-info">@TestimoniXandor</span>
            </p>
        </div>
        @else
    ...
    <div class="security-container">
        ...
        <div class="security-content">
            ...
            <div class="team-badges">
                <span class="team-badge" style="background: #fd79a8;">@XandorAcc</span>
                <span class="team-badge" style="background: #74b9ff;">X4NDO12 PARADOX</span>
                <span class="team-badge" style="background: #55efc4;">@XandorAcc</span>
            </div>
